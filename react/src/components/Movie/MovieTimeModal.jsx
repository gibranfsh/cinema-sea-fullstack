            ...
            <div className="cancellation-popup">
                ...
                <div className='mt-12-container'>
                    ...
                    <div className="movie-time-12">
                        ...
                        <button className={movieTime === "14:00" ? "selected" : "unselected"} disabled={true} onClick={() => handleMovieTime("14:00", "12-07-2023")}>SOLD OUT</button>
                        <button className={movieTime === "16:00" ? "selected" : "unselected"} disabled={true} onClick={() => handleMovieTime("16:00", "12-07-2023")}>SOLD OUT</button>
                        <button className={movieTime === "18:00" ? "selected" : "unselected"} disabled={true} onClick={() => handleMovieTime("18:00", "12-07-2023")}>SOLD OUT</button>
                    </div>
                </div>
                ...
                <div className='mt-13-container'>
                    ...
                    <div className="movie-time-13">
                        ...
                        <button className={movieTime === "14:30" ? "selected" : "unselected"} disabled={true} onClick={() => handleMovieTime("14:30", "13-07-2023")}>SOLD OUT</button>
                        ...
                        <button className={movieTime === "21:00" ? "selected" : "unselected"} disabled={true} onClick={() => handleMovieTime("21:00", "13-07-2023")}>SOLD OUT</button>
                    </div>
                </div>
